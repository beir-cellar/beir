...
class HFDataLoader:
    ...
    def _load_corpus(self):
        ...
        corpus_ds = corpus_ds.remove_columns([col for col in corpus_ds.column_names if col not in ['id', 'text', 'title', 'product', 'prepend']])
    ...
    def _load_queries(self):
        ...
        queries_ds = queries_ds.remove_columns([col for col in queries_ds.column_names if col not in ['id', 'text', 'product', 'prepend']])
